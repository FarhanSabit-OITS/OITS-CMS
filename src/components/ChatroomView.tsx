                ...
                <div key={msg.id} className={`flex gap-3 max-w-xl group ${isMe ? 'ml-auto flex-row-reverse' : ''}`}>
                  ...
                  <div className="space-y-1">
                    ...
                    <div className={`p-3 rounded-2xl relative border ${
                      ...
                      <div className="text-xs font-sans whitespace-pre-wrap leading-relaxed select-text flex items-center gap-1.5 break-all font-medium">
                        {msg.isEncrypted ? (
                          <>
                            {isFailedDecryption ? (
                              ...
                              <span className={isMe ? 'text-white' : 'text-slate-800'}>{decryptedTextStr}</span>
                            )}
                          </>
                        ) : (
